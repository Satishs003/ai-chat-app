...
## 📌 Overview
This is a full-stack AI chat application that allows users to interact with an AI model through a clean chat interface. The application is built using React for the frontend and Flask for the backend, with integration of the Cohere API for generating real-time AI responses.
